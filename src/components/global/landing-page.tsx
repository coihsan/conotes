    ...
    return (
        <section className="h-full relative w-full max-w-screen-lg mx-auto px-6 md:px-0">
            <header className="py-4 flex items-center justify-between w-full">
                <div className="text-2xl font-semibold fontChilax">conotes</div>
            ...
            <div className="flex flex-col mb-9 pt-9 max-w-screen-sm mx-auto">
                ...
                <p className="text-center text-md md:text-xl">Conotes is only available as a demo version.  All notes you create are stored in client-side storage and not persisted in any database or cloud.</p>
            </div>
